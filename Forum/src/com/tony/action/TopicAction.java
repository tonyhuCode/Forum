...
public class TopicAction extends ActionSupport implements SessionAware,ParameterAware{
	...
	@Resource private ForumTypeDao forumTypeDao;
	...
	public String addTopic(){
		...
		Date date = new Date();
		String submitTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(date);
