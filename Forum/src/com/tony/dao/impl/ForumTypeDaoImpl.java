...
public class ForumTypeDaoImpl extends DaoImpl implements ForumTypeDao {
	...
	public Set<Topic> findTopics(int typeId) {
		ForumType forumType = (ForumType) super.sessionFactory
				.getCurrentSession().get(ForumType.class, typeId);
	...
	public List<ForumType> findForumTypes() {
		...
		List<ForumType> list = super.sessionFactory.getCurrentSession().find(
				"from ForumType");
		return list;
	}
