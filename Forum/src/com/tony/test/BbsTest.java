...
public class BbsTest {
	...
	public void test1(){
		...
		for (TbUser user : userBiz.getUserAll()) {
			System.out.println("id-->"+user.getUserId()+",name-->"+user.getUsername()+",pass-->"+user.getPassword());
		}*/
		
		UserDao userDao=(UserDao) context.getBean("userDao");
		//User user = new User("zhangsan", "123456", "男", "1.gif", "走自己的路让别人去说吧！", "zhangsan@sina.com");
		//User user = new User("activity", "123456", "男", "1.gif", "活动公告斑竹", "activity@sina.com");
		//User user = new User("wangwu", "123456", "男", "1.gif", "...", "wangwu@sina.com");
		User user = new User("maliu", "123456", "男", "1.gif", "...", "maliu@sina.com");
		userDao.save(user);
	}
	/**
	 * 向ForumType添加信息
	...
	public void test4(){
		...
		/*UserDao userDao = (UserDao) context.getBean("userDao");
		Set<Topic> res = userDao.findTopics(2);*/
		for(Topic r:res){
